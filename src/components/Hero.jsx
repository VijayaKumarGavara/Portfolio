  ...
  return (
    <>
      <section className="relative w-full min-h-screen flex flex-col justify-center items-center gap-6 bg-light-bg dark:bg-dark-bg">
        <div className="px-1 flex flex-col md:flex-row sm:gap-x-2 text-light-text dark:text-dark-text font-heading font-bold text-4xl leading-loose tracking-wide">
